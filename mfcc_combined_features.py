...
save_base_dir = "/kaggle/working/gfcc_bc2_ttv"
...
feature_type = "mfcc"  # Change as needed
...
for split_name, folder_name in dataset_splits.items():
    ...
    for file_path in tqdm(wav_files, desc=f"Extracting {feature_type.upper()} + combined for {split_name.upper()}"):
        try:
            ...
            # Save as .mat
            savemat(mat_file, {'final': combined_feats})
